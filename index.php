...
<head>
    ...
    <title>Zafex Ticket Bookings</title>
    <!-- google fonts -->
...
<body>
    ...
    <header>
        <nav>
            <div>
                    <a href="#" class="nav-item nav-logo">Zafex</a>
    ...
    <section id="home">
        <div id="route-search-form">
            <h1>Zafex Bus Ticket Booking System</h1>

            <p class="text-center">Welcome to Zafex Bus Ticket Booking System. Login now to manage bus tickets and much more. OR, simply scroll down to check the Ticket status using Passenger Name Record (PNR number)</p>
    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                ...
                <p>
                   zafanana is a 30+ year old company.it dominated the northeastern province
                   from a very longtime and it still dominate upto date.
                </p>
            </div>
        </section>
        <section id="contact">
        ...
        <footer>
        <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - Zafex Bus Ticket Booking System | Made with &#10084;&#65039; by MoxamedQadar
                        </p>
        </footer>
    </div>
